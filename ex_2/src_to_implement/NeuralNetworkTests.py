...
class TestOptimizers2(unittest.TestCase):
    def test_sgd(self):
        ...
        np.testing.assert_almost_equal(result, np.array([0.0]))
...
class TestConv(unittest.TestCase):
    ...
    def test_forward_size_stride_uneven_image(self):
        ...
        output_tensor = conv.forward(input_tensor)
        self.assertEqual(
            output_tensor.shape, (self.batch_size + 1, self.num_kernels + 1, 4, 8)
        )
    ...
    def test_forward(self):
        ...
        self.assertAlmostEqual(difference, 0.0, places=1)
    ...
    def test_layout_preservation(self):
        ...
        self.assertAlmostEqual(
            np.sum(np.abs(np.squeeze(output_tensor) - input_tensor[:, 1, :, :])), 0.0
        )
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            init.fan_out, np.prod(self.kernel_shape[1:]) * self.num_kernels
        )
...
class TestPooling(unittest.TestCase):
    ...
    def test_layout_preservation(self):
        ...
        self.assertAlmostEqual(np.sum(np.abs(output_tensor - input_tensor)), 0.0)
